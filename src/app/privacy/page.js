  ...
  return (
    <main className="bg-white">
      ...
      <div className="mx-auto max-w-[48rem] px-6 pb-24 pt-12">
        <section id="privacy" className="text-zinc-600 leading-relaxed space-y-6 text-lg">
          ...
          <p className="pt-2 font-medium">📧 Contact us: <a href="mailto:theartlinemedia@gmail.com" className="text-black underline decoration-[#eb0b8b] decoration-2 underline-offset-4 hover:text-[#eb0b8b]">theartlinemedia@gmail.com</a></p>
        </section>

        <hr className="my-16 border-zinc-200" />

        <section id="terms" className="text-zinc-600 leading-relaxed space-y-6 text-lg">
        ...
        <section id="cookies" className="text-zinc-600 leading-relaxed space-y-6 text-lg">
